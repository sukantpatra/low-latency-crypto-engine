...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "tags/v3.6.0"
  WORKING_DIRECTORY "/Users/sukantpatra/HFT_Basics_Mac/build/_deps/simdjson-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("tags/v3.6.0" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: tags/v3.6.0")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/tags/v3.6.0")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"tags/v3.6.0\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/sukantpatra/HFT_Basics_Mac/build/_deps/simdjson-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/sukantpatra/HFT_Basics_Mac/build/_deps/simdjson-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
